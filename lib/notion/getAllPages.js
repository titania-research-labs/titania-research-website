...
import filterPublishedPages from './filterPublishedPages';

/**
 * @param { allowedTypes: string[] } options
 */
export async function getAllPages({ allowedTypes = ['Post'] }) {
  ...
  const posts = filterPublishedPages({ pages: data, allowedTypes });
